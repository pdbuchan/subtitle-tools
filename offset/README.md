...
Applies a positive, negative, or zero offset to every timestamp in a SubRip file. Subtitle durations are preserved, existing subtitle numbers are ignored, and entries are renumbered from 1 through N. An input Byte Order Mark is preserved.
